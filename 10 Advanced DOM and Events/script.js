...
//We use the propagation method here
...
//const testText = ` <h3 class="section__header"> 'this is to test for insertadjacentHtml'</h3>`;
//sectionHeader.insertAdjacentHTML('afterbegin', testText);
...
const alertH1 = function (e) {
  alert('addEventListener: Great you are on the heading');
...
//   alert('onmouseenter: Great you are on the heading');
// };
